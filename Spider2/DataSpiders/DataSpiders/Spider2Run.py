...
def mysql2redis(id):
    ...
    select_sql = "SELECT task_id,type1,type2,type3,type4,type5,url" \
                " FROM policy_spider_url_info WHERE task_id = %s;" % id
    ...
    while True:
        ...
        type5 = row[5]
        url = row[6]
        url_info = {url: dict(url=url, task_id=id,type1=type1, type2=type2 ,\
